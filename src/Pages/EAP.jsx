...
const tableWidth = "max-w-[600px]"

export default function EAP() {
  return (
    <>
      <div className='md:p-8 p-4'>
        <PageTitle title={"EAP - MI/AC"} description={"Lorem ipsum dolor sit amet consectetur, adipisicing elit. Culpa itaque magni omnis, iure assumenda nulla debitis dolorum voluptatibus consequatur facilis."}/>

        <Tabs defaultValue="MI" className="w-full">
          <TabsList className="h-full flex  ">
            <TabsTrigger className="w-full" value="MI">{"MI (Echelle)"}</TabsTrigger>
            <TabsTrigger className="w-full" value="MC">{"MC (Echelle)"}</TabsTrigger>
          </TabsList>
